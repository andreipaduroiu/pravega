...
public class TestConfig {
    ...
    private TestConfig(TypedProperties properties) throws ConfigurationException {
        ...
        if (this.tableType == TableType.FixedKey && (this.tableKeyLength > 256 || this.tableKeyLength % 8 != 0)) {
            throw new ConfigurationException(String.format("For Fixed-Key Tables, property '%s' must be a multiple of 8 between 0 and 256. Given %s.",
                    TABLE_KEY_LENGTH, this.tableKeyLength));
        }
